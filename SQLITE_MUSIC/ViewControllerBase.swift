...
class ViewControllerBase: UIViewController {
    ...
    func addListViewOrder(){
        ...
        let cn3 = NSLayoutConstraint(item: listView, attribute: .Height, relatedBy: .Equal, toItem: nil, attribute: .NotAnAttribute, multiplier: 1.0, constant: CGFloat(itemsOfListView.count) * 50)
    ...
    func checkHiddenSearch(){
        if txt_Search.hidden == true {
            ...
            UIView.transitionWithView(self.txt_Search, duration: 0.5, options: .TransitionCrossDissolve, animations: nil, completion: nil)
        }
