...
class TableViewCellBase: UITableViewCell {
    ...
    func addImgDetail(){
        ...
        let cn2 = NSLayoutConstraint(item: img_Detail, attribute: .Top, relatedBy: .Equal, toItem: self.contentView, attribute: .Leading, multiplier: 1.0, constant: 0)
    ...
    func addName(){
        ...
        let cn2 = NSLayoutConstraint(item: lbl_name, attribute: .Top, relatedBy: .Equal, toItem: self.contentView, attribute: .Leading, multiplier: 1.0, constant: 0)
        ...
        NSLayoutConstraint.activateConstraints([cn1,cn2,cn3,cn_lblName])
    }
