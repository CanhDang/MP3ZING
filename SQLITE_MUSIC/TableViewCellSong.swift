...
class TableViewCellSong: TableViewCellBase {
    ...
    func addBtn_Play() {
        ...
        let cn2 = NSLayoutConstraint(item: btn_Play, attribute: .Top, relatedBy: .Equal, toItem: self.contentView, attribute: .Leading, multiplier: 1.0, constant: self.contentView.center.y - 15)
    ...
    func addBtn_AddPlayList() {
        ...
        let cn2 = NSLayoutConstraint(item: btn_AddPlayList, attribute: .Top, relatedBy: .Equal, toItem: self.contentView, attribute: .Leading, multiplier: 1.0, constant: self.contentView.center.y - 15)
